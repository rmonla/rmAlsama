...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-11-2014 a las 01:55:45
...
--
-- Base de datos: `alsama_v105`
--
CREATE DATABASE IF NOT EXISTS `alsama_v105` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `alsama_v105`;
...
(1, 'TIMOFIEW', 'Andrés', 'DNI', '12.584.958', '1999-01-01', 'Casa de 1235', 'w238472947 242704', '203948204 485', 'sdoisfj@gmail.om', '', ''),
...
(2, 'timo', 1, '202cb962ac59075b964b07152d234b70', 1),
(3, 'profesor', 3, '', 2),
(4, 'director', 29, '', 2);

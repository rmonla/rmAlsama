...
?>
  ...
  <tr>
    <td>
    	<font face="Comic Sans MS" size="-1"><?php echo $ver_doc["nombre_doc"]." ".$ver_doc["apellido_doc"]; ?>
    	</font>
    </td>
    <td>
    ...
    <td>
    	<a href="editar_docente.php?codigo=<?php echo $ver_doc["cod_docente"];  ?>">
    		<img src="iconos/edi.png" width="30" height="30" border="0">
    	</a>
    </td>
    <td>
    	<a href="eliminar_docente.php?codigo=<?php echo $ver_doc["cod_docente"];  ?>"  onclick="return confirm('Desea Eliminar esta Seccion')">

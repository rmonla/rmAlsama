...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-10-2014 a las 03:15:33
...
--
-- Base de datos: `alsama_v104`
--
CREATE DATABASE IF NOT EXISTS `alsama_v104` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `alsama_v104`;
...
(2, 'PAEZ', 'JUANddddddddd', 'DNI', '12.584.958', '1999-01-01', 'Casa de 1235', 'w238472947 242704', '203948204 485', 'sdoisfj@gmail.om', '', ''),
...
(55, 'TIMOFIEU', 'Andres', 'DNI', '27075204', '1979-06-02', 'jjj', '0380 442059 - 445879', '0380 - 154254899', 'timo@yahoo.com', 'rmonla', 'sdljhdhwkjhdiwhonla,c dlhwld sdcijwlfkjsedd');
...
INSERT INTO `usrs` (`id`, `usr`, `nom`, `pass`, `cat`) VALUES
(2, 'timo', 'Andres Timofieu', '', ''),
(3, 'profesor', 'Profesor del Curso', '', ''),
(4, 'director', 'Director de la Academia', '', '');
